...
export function Intro() {
  return (
    <>
      <div>
        <Link href="/">
          <Logo className="inline-block text-gray-300 h-12 w-auto" />
        </Link>
      </div>
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Automatic review responses,{' '}
        <span className="text-sky-400">delivered instantly with AI</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Mercury is an AI messenger that crafts instant replies to your customer
        reviews, tracks competitor feedback, and escalates negative
        reviews to you - so you never miss a beat.
      </p>
      <SignUpForm />
      <div className="mt-8 flex flex-wrap text-sm/6 text-gray-400 justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        Launching August 2025. $50/month. Join our Priority List and get 50% off for 12 months! 🚀
      </div> 
    </>
  )
}
